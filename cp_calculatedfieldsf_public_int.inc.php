...
?>
<form name="<?php echo $form_data[ 1 ][ 'formid' ]; ?>" id="<?php echo $form_data[ 1 ][ 'formid' ]; ?>" action="" method="post" enctype="multipart/form-data"><script>form_structure<?php echo $CP_CFF_global_form_count; ?>=<?php print json_encode( $form_data ); ?></script>
<div id="fbuilder">
