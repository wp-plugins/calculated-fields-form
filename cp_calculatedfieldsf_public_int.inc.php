...
<form name="cp_calculatedfieldsf_pform<?php echo $CP_CFF_global_form_count; ?>" id="cp_calculatedfieldsf_pform<?php echo $CP_CFF_global_form_count; ?>" action="<?php get_site_url(); ?>" method="post"><input type="hidden" name="form_structure<?php echo $CP_CFF_global_form_count; ?>" id="form_structure<?php echo $CP_CFF_global_form_count; ?>" size="180" value="<?php echo str_replace("\r","",str_replace("\n","",esc_attr(cp_calculatedfieldsf_cleanJSON(cp_calculatedfieldsf_get_option('form_structure', CP_CALCULATEDFIELDSF_DEFAULT_form_structure,$id))))); ?>" />
<div id="fbuilder">
